...
class TorchModel(nn.Module):
    def __init__(self, vector_dim, sentence_length, vocab):
        ...
        self.layer = nn.RNN(num_layers=1,input_size=vector_dim, hidden_size=vector_dim, bias=False, batch_first=True)
    ...
    def forward(self, x, y=None):
        ...
        x, hn = self.layer(x)
        x = self.classify(hn.squeeze())             #(batch_size, vector_dim) -> (batch_size, 1)
